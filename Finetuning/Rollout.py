...
if __name__ == "__main__":
    ...
    rollout(env_name, specific_train_dataset, horizon, steps_T = 50, num_karras = 3, eta = 0.8, episode_length = 500, checkpoint_steps = 0, render = True,  goal_cell = np.array([7, 10], dtype = int), start_cell = np.array([7, 1], dtype = int))
