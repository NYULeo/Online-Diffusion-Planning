...
if __name__ == '__main__':  # pragma: no cover
    ...
    train_kernel(dataset_name = 'pointmaze', specific_dataset ='umaze', batch_size = 256, lr = 3e-4, num_steps = 25000)
    #train_kernel(dataset_name = 'pointmaze', specific_dataset ='medium', batch_size = 256, lr = 3e-4, num_steps = 50000)
