...
if __name__ == "__main__":
    ...
    rollout(env_name, specific_train_dataset, horizon, steps_T = 50, num_karras = 10, eta = 1.0, episode_length  = 3000, critic = False, checkpoint_steps = 1000000, render = True)
